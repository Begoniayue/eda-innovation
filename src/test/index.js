export const logString = `
  ...
  List Results
   ...
   > Assertion
     # Assertion: 104
     [    0] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp0cfg_executeable_assignment
     [    1] falsified   (depth=2)    (non_vacuous)  -  ct_pmp_regs.assert_p_pmp0cfg_readable_assignment
     [    2] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp0cfg_writable_assignment
     [    3] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp1cfg_executeable_assignment
     [    4] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp1cfg_readable_assignment
     [    5] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp1cfg_writable_assignment
     [    6] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp2cfg_executeable_assignment
     [    7] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp2cfg_readable_assignment
     [    8] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp2cfg_writable_assignment
     [    9] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp3cfg_executeable_assignment
     [   10] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp3cfg_readable_assignment
     [   11] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp3cfg_writable_assignment
     [   12] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp4cfg_executeable_assignment
     [   13] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp4cfg_readable_assignment
     [   14] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp4cfg_writable_assignment
     [   15] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp5cfg_executeable_assignment
     [   16] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp5cfg_readable_assignment
     [   17] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp5cfg_writable_assignment
     [   18] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp6cfg_executeable_assignment
     [   19] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp6cfg_readable_assignment
     [   20] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp6cfg_writable_assignment
     [   21] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp7cfg_executeable_assignment
     [   22] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp7cfg_readable_assignment
     [   23] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp7cfg_writable_assignment
     [   24] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_cp0_data_assignment
     [   25] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_cp0_data_assignment_1
     [   26] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmp1cfg
     [   27] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmp3cfg_blocking_assign_zero
     [   28] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmp3cfg_blocking_assign_zero_1
     [   29] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmp5cfg_blocking_assign_zero
     [   30] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmpaddr0_blocking_assign
     [   31] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmpaddr0_blocking_assign_zero
     [   32] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmpaddr1_blocking_assign_zero
     [   33] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmpaddr1_blocking_assign_zero_1
     [   34] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmpaddr2_blocking_assignment
     [   35] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmpaddr2_blocking_assignment_1
     [   36] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmpaddr3_blocking_assignment
     [   37] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmpaddr5_blocking_assignment
     [   38] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmp_updt_pmpaddr6_blocking_assignment
     [   39] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr0_value_assignment
     [   40] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr0_value_pmp_updt_pmpaddr0_2
     [   41] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr0_value_retention
     [   42] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr1_value_assignment
     [   43] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr1_value_reset
     [   44] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr1_value_retention
     [   45] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr2_value_assignment
     [   46] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr2_value_assignment_1
     [   47] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr2_value_reset
     [   48] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr2_value_retention
     [   49] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr3_value_assignment
     [   50] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr3_value_assignment_1
     [   51] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr3_value_assignment_2
     [   52] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr3_value_retention
     [   53] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr4_value_assignment
     [   54] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr4_value_reset
     [   55] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr4_value_retention
     [   56] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr5_value_assignment
     [   57] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr5_value_assignment_2
     [   58] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr5_value_retention
     [   59] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr6_value_assignment
     [   60] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr6_value_assignment_1
     [   61] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr6_value_assignment_2
     [   62] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr6_value_retention
     [   63] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr7_value_assignment_1
     [   64] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr7_value_retention
     [   65] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpaddr7_value_retention_2
     [   66] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpcfg0_value_assignment
     [   67] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpcfg0_value_assignment_31to0
     [   68] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpcfg0_value_assignment_63to32
     [   69] proven                   (non_vacuous)  -  ct_pmp_regs.assert_p_pmpcfg2_value_unchanged_1
     [   70] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp0cfg_assignment
     [   71] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp0cfg_assignment_1
     [   72] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp0cfg_assignment_2
     [   73] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp2cfg_assignment
     [   74] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp2cfg_assignment_1
     [   75] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp2cfg_assignment_2
     [   76] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp3cfg_assignment
     [   77] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp4cfg_assignment
     [   78] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp4cfg_assignment_1
     [   79] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp4cfg_assignment_2
     [   80] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp5cfg_assignment
     [   81] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp6cfg_assignment
     [   82] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp6cfg_assignment_1
     [   83] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp6cfg_assignment_2
     [   84] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp7cfg_assignment_1
     [   85] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmp7cfg_assignment_2
     [   86] proven                                  -  ct_pmp_regs.assert_pmp_updt_pmpaddr0_1_assignment
     [   87] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmpaddr0_assignment
     [   88] proven                                  -  ct_pmp_regs.assert_pmp_updt_pmpaddr1_1_assignment
     [   89] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmpaddr1_assignment
     [   90] proven                                  -  ct_pmp_regs.assert_pmp_updt_pmpaddr2_1_assignment
     [   91] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmpaddr2_assignment
     [   92] proven                                  -  ct_pmp_regs.assert_pmp_updt_pmpaddr3_1_assignment
     [   93] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmpaddr3_assignment
     [   94] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmpaddr3_blocking_assignment
     [   95] proven                                  -  ct_pmp_regs.assert_pmp_updt_pmpaddr4_1_assignment
     [   96] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmpaddr4_assignment
     [   97] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmpaddr4_blocking_assignment
     [   98] proven                                  -  ct_pmp_regs.assert_pmp_updt_pmpaddr5_1_assignment
     [   99] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmpaddr5_assignment
     [  100] proven                                  -  ct_pmp_regs.assert_pmp_updt_pmpaddr6_1_assignment
     [  101] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmpaddr6_assignment
     [  102] proven                   (non_vacuous)  -  ct_pmp_regs.assert_pmp_updt_pmpaddr6_blocking_assignment
     [  103] proven                                  -  ct_pmp_regs.assert_pmp_updt_pmpaddr7_1_assignment
`

export const analyzeString = `
The default state of pmp5cfg_readable is incorrectly set to 1 during reset, which should be 0. It affects the value of pmpcfg0_value being read.
`

export const correct_code = `
[('pmp5cfg_readable       <= 1\\'b1;', 'pmp5cfg_readable       <= 1\\'b0;')]
`
...
assign pmpcfg2_value[63:0] = cp0_pmp_wdata;
